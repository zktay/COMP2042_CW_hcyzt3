...
public class Setting implements Initializable {
    ...
    /**
     * @param event MenuBar "Exit Game" button
     *
     */
    @FXML
    ...
    /**
     *
     * @param event Retrieve color selected from the color picker
     *
     */
    @FXML
    ...
    /**
     * @param event MenuBar "Help" button
     *
     */
    @FXML
    ...
    /**
     * @param event Retrieve the level selected by the user from the level choice box
     *
     */
    @FXML
     ...
     * @param event direct user to main page on key click
     * @throws IOException handle IO error if the fxml file not found
     *
     */
    @FXML
    ...
    /**
     * @param event To set enable or disable the audio effect(endGame, winGame, gameScene audio effect)
     *
     */
    @FXML
    ...
    /**
     * @param event To set enable or disable the background audio
     *
     */
    @FXML
    ...
    /**
     * @param event To pass the size of the board to controller, the gap between the cells, and the overall size of the board
     *
     */
    @FXML
